...
\section{Zoekcriteria en referenties}

In de rest van deze oefenzitting zullen jullie starten met zoeken naar referenties.
\textbf{Als er nog geen projectleider en notulist zijn aangeduid, doe dit dan nu!}

De opdracht rond het verzamelen van zoekcriteria en referenties vind je op Toledo onder \underline{Opdrachten} $\rightarrow$ \underline{Groepsopdracht} $\rightarrow$ \underline{2. Zoekcriteria en Referenties}.
